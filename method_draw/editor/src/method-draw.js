		...
		Editor.init = function() {
			...
			$.svgIcons(curConfig.imgPath + 'svg_edit_icons.svg', {
				...
				placement: {
					...
					'#tool_fhhatch':'hatch',
					'#tool_line':'pen',
					'#tool_delete_sc':'delete',
					'#tool_rect,#tools_rect_show':'rect',
					'#tool_ellipse,#tools_ellipse_show':'ellipse',
					'#tool_path':'path',
					'#tool_text,#layer_rename':'text',
					'#tool_image':'image',
					'#tool_import_sc':'image',
					'#tool_zoom':'zoom',
		  ...
		  var width = $("#canvas_width");
			...
			var Actions = function() {
				...
				var tool_buttons = [
					...
					{sel:'#tool_import,#tool_import_sc', fn: clickImport, evt: 'click'},
					...
					{sel:'#tool_delete,#tool_delete_sc#tool_delete_multi', fn: deleteSelected, evt: 'click', key: ['del/backspace', true]},
					...
					{sel:'#tool_save_quit,#tool_save_quit_sc', fn: function() { editingsource?saveSourceEditor():clickSave(function(){ clickQuit(); });}, evt: 'click', /*'mouseup',*/ key: [modKey + 'shift+W', true]},
			...
			// 背景をインポートする。
			  var importBgImage = function(i_gbImageKey) {
				...
				{
					if (bgImages[index].key == i_gbImageKey) 
					{ 	
						// e.target.resultにBase64の画像が入る。
						svgCanvas.setHref(newImage, bgImages[index].data );
						break;
					}
				}
				svgCanvas.selectOnly([newImage]);
