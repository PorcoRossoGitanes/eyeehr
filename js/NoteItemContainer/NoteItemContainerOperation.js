 ...
 */
NoteItemContainerOperation.CreateCollection = function (i_noteCollection)
{
    var ret = Utility.CreateCollection(i_noteCollection + NoteItemContainerOperation.ClassName);
    return ret;
}